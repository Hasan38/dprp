...
if($cek==1 OR $_SESSION[leveluser]=='admin'){
echo "<li><a href='?module=kategori'><b>Kategori Berita / Program</b></a></li>";
}
...
if($cek==1 OR $_SESSION[leveluser]=='admin'){
echo "<li><a href='?module=album'><b>Album Foto</b></a></li>";
}
$cek=umenu_akses("?module=galerifoto",$_SESSION[sessid]);
if($cek==1 OR $_SESSION[leveluser]=='admin'){
echo "<li><a href='?module=galerifoto'><b>Galeri Foto</b></a></li>";
}
