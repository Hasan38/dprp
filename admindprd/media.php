...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
  ...
  <head>
    ...
    <meta name="description" content="dhiendhaspot.com - Private Training Web Development" />
    <meta name="author" content="mardhiegendhoet" />
  ...
  <body id="top">
    ...
    <div id="header-surround">
      <header id="header">
        ...
        <div id="user-info">
          <p> <a target='_blank' href=../index.php  class="button blue">Lihat Web</a> 
    ...
    <aside id="sidebar">
      ...
      <nav id="nav">
        <ul class="menu collapsible shadow-bottom">
          <li><a href="javascript:void(0);">MENU UTAMA</a><ul class="sub"><?php include "menu1.php"; ?></ul>
          <li><a href="javascript:void(0);">MODUL BERITA</a><ul class="sub"><?php include "menu2.php"; ?></ul>
          <li><a href="javascript:void(0);">MODUL VIDEO</a><ul class="sub"><?php include "menu3.php"; ?></ul>
          <li><a href="javascript:void(0);">MODUL KINERJA</a><ul class="sub"><?php include "menu4.php"; ?></ul>
          <li><a href="javascript:void(0);">MODUL INFO</a><ul class="sub"><?php include "menu5.php"; ?></ul>
          <li><a href="javascript:void(0);">MODUL USER</a><ul class="sub"><?php include "menu6.php"; ?></ul>
        </ul>
      </nav>
    </aside>
