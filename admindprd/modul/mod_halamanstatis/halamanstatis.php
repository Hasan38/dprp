...
if ($r[id_halaman]!=1){
  echo "<a href=javascript:confirmdelete('$aksi?module=halamanstatis&act=hapus&id=$r[id_halaman]&namafile=$r[gambar]') 
...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  <form method=POST action='$aksi?module=halamanstatis&act=input' enctype='multipart/form-data'>
   ...
   <textarea id='loko' name='isi_halaman'  style='width: 720px; height: 350px;'></textarea>
   </p> 
  ...
  <input type=text name='judul' size=60 value='$r[judul]'>
   ...
   <p class=inline-small-label> 
   <label for=field4>Isi Halaman</label>
   <textarea id='loko' name='isi_halaman' style='width: 550px; height: 500px;'>$r[isi_halaman]</textarea></td>
   </p> 
