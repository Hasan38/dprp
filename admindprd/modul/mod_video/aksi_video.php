...
if ($module=='video' AND $act=='hapus'){
  ...
  unlink("../../../img_video/$_GET[namafile2]");   
...
elseif ($module=='video' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysql_query("INSERT INTO video(jdl_video,
                                    ...
                                    gbr_video,
									video) 
                            VALUES('".mysql_real_escape_string($_POST[jdl_video])."',
                                   '$video_seo',
                                   '$_POST[playlist]',
								   '$_SESSION[namauser]',
								   '$jam_sekarang',
...
elseif ($module=='video' AND $act=='update'){
  ...
  UploadVideo2($nama_file_unik2);
    ...
    mysql_query("UPDATE video SET jdl_video  = '".mysql_real_escape_string($_POST[jdl_video])."',
                                   video_seo   = '$video_seo', 
