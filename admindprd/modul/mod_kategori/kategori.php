...
echo "<div class=grid_12> 
  ...
  <td width=80><center>$r[sidebar]</center></td>
...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  echo "
   ...
   <p class=inline-small-label> 
   <label for=field4>Posisi</label>
   <input type=text name='posisi' value='$r[sidebar]' size=40><br/>
	Apabila di-onlinekan di web hosting, ganti URL dengan URL website anda.
   </p>";
