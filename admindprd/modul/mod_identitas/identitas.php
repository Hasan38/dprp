  ...
  default:
   ...
   <div class='block-content'>
	...
	contoh: <span class style=\"color:#EA1C1C;\">http://phpmu.com</span>
    </p> 
      
	  
	 <p class=inline-small-label> 
    <label for=field4>Social</label>
    <input type=text name='facebook'size=50 value='$r[facebook]'><br/>
	- contoh: <span class style=\"color:#EA1C1C;\">https://www.facebook.com/pages/PHPmu/592469037441092 , https://twitter.com/robbyprihandaya , dll</span>
    </p> 
	...
	<p class=inline-small-label> 
    <label for=field4>Google Maps</label>
	<input type=text name='maps' size=50 value='$r[maps]'>
    </p>
