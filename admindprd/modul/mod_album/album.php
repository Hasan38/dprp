...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  case "tambahalbum":
   ...
   <textarea id='loko' name='keterangan' style='width: 720px; height: 200px;'></textarea>
   </p> 
  ...
  case "editalbum":
   ...
   <p class=inline-small-label> 
   <label for=field4>Keterangan</label>
   <textarea id='loko' name='keterangan' style='width: 720px; height: 200px;'>$r[keterangan]</textarea>
   </p> 
