...
echo "";
   ...
   <td><a href=mailto:$r[email]>$r[email]</a></td>";
	   if (empty($r[foto])){
			echo "<td><center><img src='../foto_user/blank.png' width=50></center></td>";
	   }else{
			echo "<td><center><img src='../foto_user/small_$r[foto]' width=50></center></td>";
	   }
   ...
   <a href='$aksi?module=user&act=hapus&id=$r[username]'  onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\" 
   ...
   $qrMod = mysql_query("SELECT * FROM modul WHERE publish='Y' AND status='user' ORDER BY id_modul");
   ...
   <label for=field4>Foto</label>";
	if (empty($r[foto])){
		echo "<img src='../foto_user/blank.png' width=100>";
   }else{
		echo "<img src='../foto_user/small_$r[foto]' width=100>";
   }
