...
switch($_GET[act]){
 ...
 echo "
   ...
   <td width=140><center>";
   if ($_SESSION[leveluser]=='admin'){
      echo "<a href='$aksi?module=berita&act=aktif&id=$r[id_berita]&status=$r[status]' title='Published / Unpublished' class='with-tip'>
    <img src='img/ya_rzl.png'>&nbsp;&nbsp;&nbsp;&nbsp;</a>";
   }
   echo "<a href=?module=berita&act=editberita&id=$r[id_berita] title='Edit' class='with-tip'>
 ...
 <img src='images/icn_trash.png' title='Hapus'></a>		        </tr>";
  ...
  <h1>TAMBAHKAN BERITA $_SESSION[leveluser]</h1>
  </div>
  <div class='block-content'>
  ...
  <input type=text name='sub_judul' size=60>
   ...
   <textarea id='loko' name='isi_berita' style='width: 720px; height: 350px;'></textarea>
   </p> 	  
  ...
  $r    = mysql_fetch_array($edit);
   ...
   <p class=inline-small-label> 
   <label for=field4>Judul Berita</label>
   <input type=text name='judul' size=60 value='".cetak($r[judul])."'>
   </p> 	

   <p class=inline-small-label> 
   <label for=field4>Sub Judul Berita</label>
  <input type=text name='sub_judul' size=60 value='".cetak($r[sub_judul])."'>
   </p> 
   ...
   <p class=inline-small-label> 
   <label for=field4>Isi Berita</label>
   <textarea id='loko' name='isi_berita' style='width: 720px; height: 350px;'>$r[isi_berita]</textarea>
   </p> 	  
   ...
   <p class=inline-small-label> 
    <label for=field4>Keterangan Gbr</label>
   <input type=text name='keterangan_gambar' value='".cetak($r[keterangan_gambar])."'>
   </p>";
