...
switch($_GET[act]){
  ...
  <td>
   <a href=?module=galerifoto&act=editgalerifoto&id=$r[id_gallery] title='Edit' rel=tooltip-top class='with-tip'>
  ...
  <td>
   ...
   title='Hapus' rel=tooltip-top class='with-tip'>
  ...
  //TAMBAH//////////////////////////
   ...
   <textarea name='keterangan' style='width: 550px; height: 200px;'></textarea>
   </p> 	
  ...
  <textarea name='keterangan' style='width: 550px; height: 200px;'>$r[keterangan]</textarea>
   </p>		  
