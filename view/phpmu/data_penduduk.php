        ...
        <article class="article-container" itemscope itemtype="http://schema.org/Article">
            <div class="article-content blog-page">
                ...
                <div class="blog-items style-1">
                    <ul class="list-unstyled">
					<?php
						$row = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM data_penduduk where id_data_penduduk='".anti_injection($_GET[idp])."'"));
						echo "<div class='col-md-6'>
							  ...
							  <div style='clear:both'></div><br>
								  ...
								  <tbody>";
								  $tampil=mysqli_query($conn,"SELECT * FROM data_penduduk_detail where id_data_penduduk='".cetak($_GET[idp])."'");
								  $no=1;
