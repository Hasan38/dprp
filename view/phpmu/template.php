...
<body>
  <?php
    // warna grafik --
    $w[1]="rgba(255,99,132, 0.5)";
    $w[2]="rgba(54, 162, 235, 0.5)";
    $w[3]="rgba(255, 206, 86, 0.5)";
    $w[4]="rgba(75, 192, 192, 0.5)";
    $w[5]="rgba(153, 102, 255, 0.5)";
    $w[6]="rgba(255, 159, 64, 0.5)";
    $w[7]="rgba(255, 99, 132, 0.5)";
    $w[8]="rgba(54, 162, 235, 0.5)";
    $w[9]="rgba(255, 206, 86, 0.5)";
    $w[10]="rgba(75, 192, 192, 0.5)";
    $w[11]="rgba(153, 102, 255, 0.5)";
    $w[12]="rgba(255, 159, 64, 0.5)";

    $wb[1]="rgba(255,99,132, 1)";
    $wb[2]="rgba(54, 162, 235, 1)";
    $wb[3]="rgba(255, 206, 86, 1)";
    $wb[4]="rgba(75, 192, 192, 1)";
    $wb[5]="rgba(153, 102, 255, 1)";
    $wb[6]="rgba(255, 159, 64, 1)";
    $wb[7]="rgba(255, 99, 132, 1)";
    $wb[8]="rgba(54, 162, 235, 1)";
    $wb[9]="rgba(255, 206, 86, 1)";
    $wb[10]="rgba(75, 192, 192, 1)";
    $wb[11]="rgba(153, 102, 255, 1)";
    $wb[12]="rgba(255, 159, 64, 1)";
  ?>
    ...
    <div class="header-background">
        ...
        <div style='background:#e3e3e3'>
                <?php
                  $logoo=mysqli_query($conn,"SELECT * FROM logo ORDER BY id_logo DESC LIMIT 1");
                  while($b=mysqli_fetch_array($logoo)){
    ...
    <div class="container main-site-container" itemscope itemtype="http://schema.org/CreativeWork">
        <div class="row">
            <?php 
                if ($_GET['module']=='detilprogres'){
                    echo "<div class='col-md-12'>";
                      include "detilprogres.php";
                    echo "</div>";
                }else{
            ?>
                    <div class="col-md-8">
    ...
    <!-- Chart.js -->
    <script src="<?php echo "$f[folder]/js/Chart.js/dist/Chart.min.js" ?>"></script>
    <!-- Mobile Menu -->
