		...
		<article class="article-container clearfix" itemscope itemtype="http://schema.org/Article">
                    <div class="article-content clearfix">
                        ...
                        <div class="post-entry" itemprop="articleBody">
							...
							<?php
							$id = $d['id_berita'] - 1;
							$prev = mysqli_query($conn,"SELECT * FROM berita where id_berita='$id'");
							...
							<?php
							$idd = $d['id_berita'] + 1;
							$prevd = mysqli_query($conn,"SELECT * FROM berita where id_berita='$idd'");
