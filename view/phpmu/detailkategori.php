<!-- main content -->
                <article class="article-container" itemscope itemtype="http://schema.org/Article">
                    <div class="article-content blog-page">
                        <header>
						<?php
							$sq = mysqli_query($conn,"SELECT nama_kategori from kategori where id_kategori='".anti_injection($_GET[kt])."'");
                        ...
                        <div class="blog-items style-1">
							...
							if ($jumlah > 0){
							  ...
							  $komentar = mysqli_query($conn,$komen);
							...
							<?php
								$jmldata     = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM berita WHERE id_kategori='".anti_injection($_GET[kt])."'"));
