...
if($halaman_aktif > 1){
	...
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=".anti_injection($_GET[module])."&halaman=1 class='nextprev'>Awal</a>
                    <a href=$_SERVER[PHP_SELF]?module=".anti_injection($_GET[module])."&halaman=$prev class='nextprev'>Kembali</a>";
}
else{ 
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "  <span class='nextprev'>...</span><a href=$_SERVER[PHP_SELF]?module=".anti_injection($_GET[module])."&halaman=$jmlhalaman>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	...
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=".anti_injection($_GET[module])."&halaman=$next class='nextprev'>Lanjut</a>
                     <a href=$_SERVER[PHP_SELF]?module=".anti_injection($_GET[module])."&halaman=$jmlhalaman class='nextprev'>Akhir</a> ";
}
else{
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halkategori-".anti_injection($_GET[kt])."-1.html class='nextprev'>Awal</a>
                    <a href=halkategori-".anti_injection($_GET[kt])."-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
$link_halaman .= "<span class='nextprev'>Awal</span>
<span class='nextprev'>Kembali</span>";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halkategori-".anti_injection($_GET[kt])."-$i.html>$i</a>";
  }
	 $angka .= " <span class='current'><b>$halaman_aktif</b></span>";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halkategori-".anti_injection($_GET[kt])."-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halkategori-".anti_injection($_GET[kt])."-$next.html class='nextprev' >Lanjut</a>
                     <a href=halkategori-".anti_injection($_GET[kt])."-$jmlhalaman.html class='nextprev'>Akhir</a>";
}
else{
	$link_halaman .= "<span class='nextprev'>Lanjut</span>
	<span class='nextprev'>Akhir</span>";
...
if($halaman_aktif > 1){
	...
	$link_halaman .= "<a href=haltag-$_GET[id]-1.html class='nextprev'>Awal</a>
                    <a href=haltag-$_GET[id]-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
$link_halaman .= "<span class='nextprev'>Awal</span>
<span class='nextprev'>Kembali</span>";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=haltag-$_GET[id]-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=haltag-$_GET[id]-$next.html class='nextprev' >Lanjut</a>
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halfotoberita'])){
	$posisi=0;
	$_GET['halfotoberita']=1;
}
else{
	$posisi = ($_GET['halfotoberita']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halaman-album-".anti_injection($_GET[ald])."-1.html class='nextprev'>Awal</a> 
                    <a href=halaman-album-".anti_injection($_GET[ald])."-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
	$link_halaman .= "<span class='nextprev'>Awal</span> 
	<span class='nextprev'>Kembali</span>  ";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halaman-album-".anti_injection($_GET[ald])."-$i.html>$i</a>";
  }
	  $angka .= " <span class='current'><b>$halaman_aktif</b></span>";
    ...
    if($i > $jmlhalaman)
      break;
	  $angka .= "<a href=halaman-album-$_GET[ald]-$i.html>$i</a>";
    }
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <span class='nextprev'>...</span><a href=halaman-album-".anti_injection($_GET[ald])."-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halaman-album-".anti_injection($_GET[ald])."-$next.html class='nextprev' >Lanjut</a>
                     <a href=halaman-album-".anti_injection($_GET[ald])."-$jmlhalaman.html class='nextprev'>Akhir</a>";
}
else{
	$link_halaman .= "<span class='nextprev'>Lanjut</span>
	<span class='nextprev'>Akhir</span>";
